...
class Chasilism2 extends MovieClip {
    ...
    private static var _epicenterX      : Number;
    private static var _epicenterY      : Number;
	/*private static var
	private static var*/
	
	
	public function Chasilism2 ()
	{
		_scope 			= this._parent;
		//trace("scope: "+_scope)
		_logoId			= "portal";
		...
		_transitionX	= 0;
		_transitionY	= 0;
		_epicenterX		= _width/2;
		_epicenterY		= _height/2;
		_minY			= -20
		_maxY			= 20;
	...
	public static function init(obj) : Void
	{
		...
		if(obj.epicenterX) _epicenterX	= obj.epicenterX;
		if(obj.epicenterY) _epicenterY	= obj.epicenterY;
	}
	...
	{
		clearInterval(_int);
		_bmpData.fillRect(new Rectangle(_transitionX, _transitionY, _width, _height), 0x00FF0000);
		_logos			= new Array();
		makeGrid();	
	}
