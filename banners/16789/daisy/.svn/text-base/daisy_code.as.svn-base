...
var paramObjectRef:String = "ID_DAISY_1";
...
function yTween(mc:MovieClip, dlay:Number):Void {
	...
	// TweenLite.from(mc, TEXT_SPEED, { _y:mc._y+50, ease:Expo.easeOut, delay:dlay });
};
	...
	topMenu.onRollOver = function():Void {
		...
		switch(bsize)
		{
			case 300 :
				...
				break;
			case 120 :
				TweenLite.to(this.bg, .5, { _xscale:68, ease:Expo.easeOut });
				TweenLite.to(this.msk, .5, { _xscale:68, ease:Expo.easeOut });
				break;
			case 160 :
				//
				break;
