...
class StandardV3_160x600 extends Engine {
	
	private function StandardV3_160x600 ( scope )
	{
	...
	public static function create(scope:MovieClip) {
		...
		instance = new StandardV3_160x600(scope);
		return instance;
	}
	...
	private function endFrame ( ) : Void
	{
		...
		TweenLite.to ( inkMeansPoints, speed, {_y : 92, delay: delay } ) ;
