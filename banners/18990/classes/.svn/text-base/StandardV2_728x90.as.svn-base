...
class StandardV2_728x90 extends Engine {
	
	private function StandardV2_728x90 ( scope )
	{
	...
	public static function create(scope:MovieClip) {
		...
		instance = new StandardV2_728x90(scope);
		return instance;
	}
	...
	private function inkMeansPointsSection ( ) : Void
	{
		...
		//TweenLite.to ( chaseCard, 0.5, {_x : 376, delay : 1 } ) ;
