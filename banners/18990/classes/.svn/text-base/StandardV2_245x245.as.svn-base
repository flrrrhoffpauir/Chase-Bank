...
class StandardV2_245x245 extends Engine {
	

	
		private function StandardV2_245x245 ( scope ) 
		{
			super ( scope ) ;
		}
		...
		public static function create ( scope : MovieClip ) {
			...
			instance = new StandardV2_245x245(scope);
			return instance;
		}
		...
		private function endFrame ( ) : Void
		{
			...
			TweenLite.to ( chaseCard, speed, {_y : 107, delay: delay } ) ;
...
class StandardV2_245x245 extends Engine {
		...
		private function endFrame ( ) : Void
		{
			...
			TweenLite.to ( inkMeansPoints, speed, {_y : inkMeansPoints._y - 9, delay: delay } ) ;
			TweenLite.to ( chaseCard, speed, {_y : chaseCard._y - 17, delay: delay } ) ;
			TweenLite.to ( introducingInkFromChase, speed, {_y : introducingInkFromChase._y - learnMore._height - padding, _alpha : 100, delay: delay } ) ;
			TweenLite.to ( learnMore, speed, { _alpha : 100, delay : delay });
