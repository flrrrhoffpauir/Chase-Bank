...
class StandardV2_200x130 extends Engine {
	

	
		private function StandardV2_200x130 ( scope ) 
		{
			super ( scope ) ;
		}
		...
		public static function create ( scope : MovieClip ) {
			...
			instance = new StandardV2_200x130(scope);
			return instance;
		}
		...
		private function endFrame ( ) : Void
		{
			...
			TweenLite.to ( inkMeansPoints, speed, {_y : inkMeansPoints._y - 8, delay: delay } ) ;
