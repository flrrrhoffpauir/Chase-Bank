...
class flexicard.FlexicardBanner
{
	...
	/**
	 *  FlexicardBanner Constructor
	 */
	public function FlexicardBanner(bannerID:Number) { _bannerID = bannerID; };
	...
	private function step6(bannerID:Number):Void
	{
		...
		switch(bannerID) // 0:160x600, 1:300x250, 2:336x280, 3:300x600, 4:728x90
		{
			case 0 :
				TweenLite.to(_root.stroke, 0.5, { _y:316, ease:Strong.easeOut });
				break;
			case 4 :
