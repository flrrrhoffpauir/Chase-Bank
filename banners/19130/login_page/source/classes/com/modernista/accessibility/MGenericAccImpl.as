...
package com.modernista.accessibility {
	 ...
	 */
	public class MGenericAccImpl extends AccessibilityProperties {
		/**
		 *  @private
		...
		public static function createAccessibilityImplementation(displayObject:DisplayObject):void {
			displayObject.accessibilityProperties = new MGenericAccImpl(displayObject);
		}
         ...
         * @playerversion Flash 9.0.28.0
		 */
		public function MGenericAccImpl(displayObject:DisplayObject) {
			super();
