package com.modernista.accessibility
{
	...
	/**
	 *  The MAccImpl class, also called the Accessibility Implementation class, is the base class 
	 ...
	 */ 
	public class MAccImpl extends AccessibilityImplementation 
	{
		//--------------------------------------------------------------------------
		//  Class constants
		//--------------------------------------------------------------------------
		...
		/**
         *  @private (protected)
		 *  A reference to the DisplayObject instance that this AccImpl instance
		...
		public static function createAccessibilityImplementation(sprite:Sprite):void {
			sprite.accessibilityImplementation = new MAccImpl(sprite);
		}
         ...
         * @playerversion Flash 9.0.28.0
		 */
		public function MAccImpl(sprite:Sprite) {
			super();
			stub = false;
			master = sprite;
			
			MGenericAccImpl.createAccessibilityImplementation(master as DisplayObject);
		...
		protected function getState(childID:uint):uint {
			...
			if (master is UIComponent && !UIComponent(master).enabled) {
